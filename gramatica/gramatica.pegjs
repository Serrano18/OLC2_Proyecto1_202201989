...
booleano 
    = "true" / "false"  {return new CrearNodo('primitivo', { tipo: 'booean', valor: text() === 'true' ? true : false })}

cadena 
    = "\"" (!"\"" .)* "\""   {return new CrearNodo('primitivo', { tipo: 'string', valor: text().slice(1, -1) })}

char 
    = "'" (!"'" .) "'"     {return new CrearNodo('primitivo', { tipo: 'char', valor: text().slice(1, -1) })}

idvalue
     = id:id    {return new CrearNodo('ReferenciaVariable', {id})}
